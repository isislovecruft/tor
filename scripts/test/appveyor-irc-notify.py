...
Modified by isis agora lovecruft <isis@torproject.org> in 2018:
 ...
 - Make bot join channel rather than sending NOTICE messages externally.
...
in Appveyor's YAML:
    ...
    on_success:
      - "python scripts/test/appveyor-irc-notify.py irc.oftc.net:6697 tor-ci '{repo_name} {color_white}{branch}{color_reset} {short_commit} - {author}: {message}','Build #{build_version} {color_green}passed{color_reset}. Details: {color_blue}{build_url}{color_reset} |  Commit: {color_blue}{commit_url}{color_reset}'"
      # - "python etc/scripts/irc-notify.py irc.oftc.net:6697 tor-ci [{project_name}:{branch}] {short_commit}: \"{message}\" ({author}) {color_green}Succeeded,Details: {build_url},Commit: {commit_url}"
    on_failure:
      - "python scripts/test/appveyor-irc-notify.py irc.oftc.net:6697 tor-ci '{repo_name} {color_white}{branch}{color_reset} {short_commit} - {author}: {message}','Build #{build_version} {color_red}failed{color_reset}. Details: {color_blue}{build_url}{color_reset} |  Commit: {color_blue}{commit_url}{color_reset}'"
      # - "python etc/scripts/irc-notify.py irc.oftc.net:6697 tor-ci [{project_name}:{branch}] {short_commit}: \"{message}\" ({author}) {color_red}Failed,Details: {build_url},Commit: {commit_url}"
"""
